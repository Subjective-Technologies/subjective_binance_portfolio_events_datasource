...
class SubjectivePortfolioEventsDataSource(SubjectiveDataSource):
    connection_type = "Portfolio"
    connection_fields = ["portfolio_id", "storage"]
    ...
    def fetch(self):
        ...
        self._emit_result({"portfolio": portfolio.get_portfolio(), "orders": portfolio.get_orders()})
